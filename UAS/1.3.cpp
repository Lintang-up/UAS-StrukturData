...
int main(){
		addFirst("2101030", "Liye", "perempuan", "karanganyar", "02-03-2003", "Botok,Kerjo,Karanganyar", "SDN1", "-", 90, 80, 80, 0);
		addFirst("2245866", "Ades", "laki-laki", "surakarta", "23-05-2003", "Botok,Kerjo,Karanganyar", "SDN5", "-", 65, 80, 69, 0);
		addFirst("2754866", "Mineral", "laki-laki", "jatim", "18-05-2003", "Botok,Kerjo,Karanganyar", "SDN8", "-", 75, 50, 66, 0);
		addFirst("2210368", "Aqua", "laki-laki", "pekalongan", "18-06-2003", "Botok,Kerjo,Karanganyar", "SDN4", "-", 45, 90, 59, 0);
		addLast("5223653", "Dee", "perempuan", "klaten", "12-12-2003", "Botok,Kerjo,Karanganyar", "SDN5", "-", 90, 88, 70, 0);
		addLast("5464334", "Fiersa Besari", "laki-laki", "smg", "21-08-2003", "Botok,Kerjo,Karanganyar", "SDN2", "-", 57, 52, 70, 0);
		addLast("5464334", "Dee", "perempuan", "solo", "26-04-2003", "Botok,Kerjo,Karanganyar", "SDN2", "-", 68, 55, 30, 0);
		addLast("5464334", "Dee", "laki laki", "kra", "26-04-2088", "Botok,Kerjo,Karanganyar", "SDN2", "-", 68, 99, 99, 0);
		addLast("3244563", "des", "perempuan", "pacitan", "25-12-2003", "Botok,Kerjo,Karanganyar", "SDN1", "-", 78, 97, 92, 0);
	...
	cout << "|                                                |\n";
	cout << "|4. Ubah Data Siswa                              |\n";
	cout << "|                                                |\n";
	cout << "|5. Delete Data Atas/Awal                        |\n";
	cout << "|6. Delete Data Tengah                           |\n";
	cout << "|7. Delete Data Bawah/Akhir                      |\n";
	cout << "|                                                |\n";
	cout << "|8. Tampil Data Siswa yang Sudah Mendaftar       |\n";
	cout << "|9. Sorting Data Siswa                           |\n";
	cout << "|10. Searching Data Siswa                        |\n";
	cout << "|11. Keluar                                      |\n";
	cout << "+------------------------------------------------+\n";
    ...
    else if (pilih == 5)
    {
    	...
    	getch();
    	removeFirst();
    	cout << "\n\nSetelah Di Hapus Data Awal/Atas\n";
    	printSingleLinkedList();
		getch();
        goto menu;
    }
    ...
    {
    	system("cls");
    	cout << "Sebelum Di Hapus Data Tengah\n";
    	printSingleLinkedList();
    	cout << "Masukkan No Data Yang Ingin Di Hapus = "; cin >> posisi;
    	removeMiddle(posisi);
    	cout << "\nSetelah Di Hapus Data Tengah\n";
    	printSingleLinkedList();
		getch();
        goto menu;
    } 
    ...
    else if (pilih == 7)
    {
    	...
    	getch();
    	removeLast();
    	cout << "\n\nSetelah Di Hapus Data Akhir/Bawah\n";
    	printSingleLinkedList();
		getch();
        goto menu;
    }

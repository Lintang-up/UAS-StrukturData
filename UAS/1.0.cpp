...
void createSingleLinkedList(int nisn, string nama, string jk, string tempat, string tgllahir, string alamat, string asal_sd, 
							float nilai1, float nilai2, float nilai3, float hasil, string keterangan)
	{
  	head = new Siswa();
 	head->nisn = nisn;
  	head->nama = nama;
...
// tambahAwal
void addFirst(int nisn, string nama, string jk, string tempat, string tgllahir, string alamat, string asal_sd, 
							float nilai1, float nilai2, float nilai3, float hasil, string keterangan){
...
// tambahAkhir
void addLast(int nisn, string nama, string jk, string tempat, string tgllahir, string alamat, string asal_sd, 
							float nilai1, float nilai2, float nilai3, float hasil, string keterangan){
	if (head == NULL)  //jika head kosong maka kita buat singlelist dulu
	{
	  	head = new Siswa();
...
// tambah tengah
void addMiddle(int nisn, string nama, string jk, string tempat, string tgllahir, string alamat, string asal_sd, 
							float nilai1, float nilai2, float nilai3, float hasil, string keterangan, int posisi){
...
void printSingleLinkedList(){
  ...
  {
  	cout << "|" << nomor + 1 << ". |";
  	cout << setiosflags(ios::left) << " " << setw(8) << cur->nisn;
	cout << setiosflags(ios::left) << setw(11) << cur->nama;
	cout << setiosflags(ios::left) << setw(11) << cur->jk;
	cout << setiosflags(ios::left) << setw(11) << cur->tempat;
	cout << setiosflags(ios::left) << setw(11) << cur->tgllahir;
	cout << setiosflags(ios::left) << setw(11) << cur->alamat;
	cout << setiosflags(ios::left) << setw(11) << cur->asal_sd;
	cout << setiosflags(ios::left) << setw(11) << cur->nilai1;
	cout << setiosflags(ios::left) << setw(11) << cur->nilai2;
	cout << setiosflags(ios::left) << setw(11) << cur->nilai3;
...
int main(){
		addFirst(nisn, nama, jk, tempat, tgllahir,alamat, asal_sd, nilai1, nilai2, nilai3);
		addFirst("2101030", "Liye", "perempuan", "karanganyar", "2003", "Botok,Kerjo,Karanganyar", "SDN1", 90, 80, 80);
		addFirst("2210866", "Tere", "perempuan", "sragen", "2003", "Botok,Kerjo,Karanganyar", "SDN2", 95, 70, 80);
		addLast("5223653", "Dee", "perempuan", "klaten", "2003", "Botok,Kerjo,Karanganyar", "SDN5", 90, 88, 70);
		addLast("2343534", "Fiersa Besari", "laki-laki", "smg", "2003", "Botok,Kerjo,Karanganyar", "SDN2", 97, 82, 80);
		addLast("5464334", "Dee", "perempuan", "solo", "2003", "Botok,Kerjo,Karanganyar", "SDN2", 88, 85, 90);
		addLast("3244563", "des", "perempuan", "pacitan", "2003", "Botok,Kerjo,Karanganyar", "SDN1", 78, 97, 92);
    ...
    if (pilih == 1)
    {
		...
		cout << "Masukkan Tgl lahir     = ";	cin >> tgllahir;
		cout << "Masukkan Alamat        = ";	cin >> alamat;
		cout << "Masukkan Asal SD       = ";	cin >> asal_sd;
    ...
    else if (pilih == 2)
    {
		...
		addMiddle(nisn, nama, jk, tempat, tgllahir,alamat, asal_sd, nilai1, nilai2, nilai3, posisi);
        goto menu;
    }
    ...
    else if (pilih == 3)
    {
		...
		cout << "Masukkan Nilai MTK     = ";	cin >> nilai2;
		cout << "Masukkan Nilai BI      = ";	cin >> nilai3;
		addLast(nisn, nama, jk, tempat, tgllahir,alamat, asal_sd, nilai1, nilai2, nilai3);
        goto menu;
    }
